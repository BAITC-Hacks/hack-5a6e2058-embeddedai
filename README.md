...
![Синтетический пример: карта сообществ и объяснение узла](docs/images/demo.png)
...
Правила версии 2.0 находятся в [config/rules.json](config/rules.json).
...
- Приоритет и роли чувствительны к порогам и границам выборки. Формулы — открытая
  эвристика v2, не валидированная банковская модель принятия решений.
