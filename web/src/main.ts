...
$("app").innerHTML = `
  ...
  <section class="workspace">
    ...
    <aside id="detail" class="detail" tabindex="0" aria-label="Карточка выбранного узла"><div class="empty-card"><span class="empty-symbol">⌘</span><h2>За каждым узлом — факты</h2><p>Выберите узел на карте или в списке приоритетов. Здесь появятся его потоки, роль и основания для проверки.</p><div class="subtle-box">Роль — гипотеза по наблюдаемым данным, а не вывод о виновности.</div></div></aside>
