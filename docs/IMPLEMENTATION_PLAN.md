...
Ниже сохранён исходный план v1 как исторический документ, включая прежние решения
о составе репозитория. В текущем приватном репозитории `data/data/` уже есть;
правила публикации публичного демо остаются прежними. Актуальная методика v2.1 —
