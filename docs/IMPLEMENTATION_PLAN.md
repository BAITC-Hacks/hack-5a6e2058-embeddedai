...
Статус: кейс выбран; ТЗ, файлы и starter изучены; выполнен диагностический
анализ данных. Приложение пока не реализовано. Ниже — план работ, а не описание
готовых функций. Расписание рассчитано на пятичасовой бюджет разработки;
